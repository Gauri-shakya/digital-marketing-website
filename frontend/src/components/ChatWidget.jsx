      ...
      if (text.includes('@') && text.includes('.')) {
        setTimeout(() => {
          setMessages(prev => [...prev, {
            text: "I noticed you shared an email. Would you like our team to reach out to you directly?",
            sender: 'bot',
            action: 'lead_form',
            time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })
          }]);
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-14 sm:bottom-16 right-0 w-[calc(100vw-32px)] sm:w-[355px] max-w-[355px] max-h-[calc(100vh-100px)] sm:max-h-[calc(100vh-110px)] bg-slate-900 rounded-2xl flex flex-col overflow-hidden border border-slate-700/50 shadow-[0_8px_40px_rgba(99,102,241,0.22)]"
          >
            {/* Ambient glow */}
            ...
            {/* ── Messages ── */}
            <div className="flex-1 overflow-y-auto px-3.5 py-4 space-y-4 min-h-[260px]">
